...
! function(t, e, i) {
	...
	t.zui({
		uuid: function() {
			return 1e3 * (new Date).getTime() + n++ % 1e3
		},
		callEvent: function(e, o, n) {
			if (t.isFunction(e)) {
				n !== i && (e = t.proxy(e, n));
				var a = e(o);
				return o && (o.result = a), !(a !== i && !a)
			}
			return 1
		},
		clientLang: function() {
		...
		getMouseButtonCode: function(t) {
			return "number" != typeof t && (t = o[t]), t !== i && null !== t || (t = -1), t
		}
	}), t.fn.callEvent = function(e, o, n) {
		var a = t(this),
			s = e.indexOf(".zui."),
			r = s < 0 ? e : e.substring(0, s),
			l = t.Event(r, o);
		if (n === i && s > 0 && (n = a.data(e.substring(s + 1))), n && n.options) {
			var d = n.options[r];
			t.isFunction(d) && t.zui.callEvent(d, l, n)
		}
...
function(t) {
	...
	i.prototype.show = function() {
		var i = this.element,
			...
			n = i.attr("data-target") || i.attr("data-tab");
		if (n || (n = i.attr("href"), n = n && n.replace(/.*(?=#[^\s]*$)/, "")), !i.parent("li").hasClass("active")) {
			var a = o.find(".active:last a")[0],
				s = t.Event("show." + e, {
					relatedTarget: a
				});
	...
	t.fn.collapse = function(o) {
		return this.each(function() {
			var n = t(this),
				a = n.data(e),
				s = t.extend({}, i.DEFAULTS, n.data(), "object" == typeof o && o);
...
function(t, e) {
	...
	var i = 1200,
		...
		r = function() {
			var t = s.width();
			e("html").toggleClass(a.desktop, t >= o && t < i).toggleClass(a.desktopLg, t >= i).toggleClass(a.tablet, t >= n && t < o).toggleClass(a.phone, t < n).toggleClass(a.isMobile, t < o).toggleClass(a.touch, "ontouchstart" in document.documentElement).toggleClass(a.isDesktop, t >= o)
		};
	s.resize(r), r()
}(window, jQuery),
function(t) {
	...
	i.prototype.cssHelper = function() {
		...
		o.length || (o = t('<div id="browseHappyTip" class="alert alert-dismissable alert-danger-inverse alert-block" style="position: relative; z-index: 99999"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><div class="container"><div class="content text-center"></div></div></div>'), o.prependTo("body")), o.find(".content").html(i || this.browseHappyTip || e[t.zui.clientLang() || "zh_cn"])
	...
	String.prototype.format || (String.prototype.format = function(t) {
		...
		if (arguments.length > 0) {
			...
			if (arguments.length <= 2 && "object" == typeof t)
				for (var o in t) void 0 !== t[o] && (i = new RegExp("(" + (arguments[1] ? arguments[1].replace("0", o) : "{" + o + "}") + ")", "g"), e = e.replace(i, t[o]));
			else
				for (var n = 0; n < arguments.length; n++) void 0 !== arguments[n] && (i = new RegExp("({[" + n + "]})", "g"), e = e.replace(i, arguments[n]))
		}
		return e
	...
	e.DEFAULTS = {
		...
		this.$body.find(this.selector).map(function() {
			...
			return a && a.length && a.is(":visible") && [
				[a[e]().top + (!t.isWindow(i.$scrollElement.get(0)) && i.$scrollElement.scrollTop()), n]
			] || null
		}).sort(function(t, e) {
			return t[0] - e[0]
		}).each(function() {
			...
			x = function(i) {
				...
				if (!(l > -1 && i.button !== l)) {
					...
					n = p.offset(), o = {
						...
						x: i.pageX - f.left + n.left,
						y: i.pageY - f.top + n.top
...
function(t, e, i) {
	...
	s.DEFAULTS = n, s.NAME = o, s.prototype.trigger = function(e, i) {
		...
		var n, a, s, r, l, d, h, c, p, f, u, g, m, v = this,
			y = v.$,
			b = v.options,
			w = b.deviation,
			C = "." + o + "." + v.id,
			...
			z = y,
			I = !1,
			j = S ? t(b.container).first() : k ? y : t("body"),
			L = function(e) {
				if (I && (u = {
						left: e.pageX,
						top: e.pageY
					}, !(i.abs(u.left - c.left) < w && i.abs(u.top - c.top) < w))) {
					if (null === s) {
						...
						"absolute" != o && "relative" != o && "fixed" != o && (d = o, j.css("position", "relative")), s = z.clone().removeClass("drag-from").addClass("drag-shadow").css({
							...
							width: z.outerWidth(),
							transition: "none"
						}).appendTo(j), z.addClass("dragging"), v.trigger("start", {
							event: e,
							element: z
						})
					}
					...
					if (n.each(function() {
							...
							if (u.left > a && u.top > s && u.left < a + o && u.top < s + n && (C && C.removeClass("drop-to"), C = e, !b.nested)) return !1
						}), C) {
						r = !0;
						var $ = C.data("id");
			...
			M = function(i) {
				var o = t.zui.getMouseButtonCode(b.mouseButton);
				if (!(o > -1 && i.button !== o)) {
					var u = t(this);
					k && (z = D ? u.closest(k) : u), z.hasClass("drag-shadow") || b.before && b.before({
						event: i,
						element: z
	...
	o.VERSION = "3.2.0", o.TRANSITION_DURATION = 300, o.BACKDROP_TRANSITION_DURATION = 150, o.DEFAULTS = {
		...
		if ("undefined" == typeof e && (e = this.options.position), "undefined" != typeof e) {
			var o = this.$element.find(".modal-dialog"),
				n = Math.max(0, (t(window).height() - o.outerHeight()) / 2),
				a = "fit" == e ? 2 * n / 3 : "center" == e ? n : e;
			if (o.hasClass("modal-moveable")) {
				var s = null,
					r = this.options.rememberPos;
				r && (r === !0 ? s = this.$element.data("modal-pos") : t.zui.store && (s = t.zui.store.pageGet(i + ".rememberPos." + r))), s || (s = {
		...
		var e = this,
			o = e.options,
			n = e.$element.find(".modal-dialog").removeClass("modal-dragged");
		n.toggleClass("modal-moveable", o.moveable), e.$element.data("modal-moveable-setup") || n.draggable({
			...
			finish: function(n) {
				var a = o.rememberPos;
				a && (e.$element.data("modal-pos", n.pos), t.zui.store && a !== !0 && t.zui.store.pageSet(i + ".rememberPos." + a, n.pos))
			}
		})
		...
		this.isShown && this.options.keyboard ? t(document).on("keydown.dismiss." + i, t.proxy(function(e) {
			if (27 == e.which) {
				var o = t.Event("escaping." + i),
					n = this.$element.triggerHandler(o, "esc");
...
function(t, e) {
	...
	s.DEFAULTS = {
		...
		var r = this;
		if (s.url && (!s.type || s.type != o && "iframe" != s.type) && (s.type = o), s.remote) s.type = o, typeof s.remote === a && (s.url = s.remote);
		...
		var l = this,
			...
			h = this.$dialog,
			c = r.custom,
			p = h.find(".modal-body").css("padding", ""),
			f = h.find(".modal-header"),
			u = h.find(".modal-content");
		...
		if ("custom" === r.type && c)
			...
			} else c instanceof t ? (p.html(t("<div>").append(c.clone()).html()), m()) : (p.html(c), m());
		else if (r.url) {
			var y = function() {
		...
		ModalTrigger: s,
		modalTrigger: new s
	}), t.fn.modalTrigger = function(e, o) {
	...
	t.zui({
		...
		a && a.length || (o.data(i) ? o.trigger(".toggle." + i) : o.modalTrigger({
			show: !0
	...
	e.DEFAULTS = {
		...
		if ("top" == e && d != a && (i = !0, t.top = t.top + a - d), /bottom|top/.test(e)) {
			var h = 0;
			t.left < 0 && (h = t.left * -2, t.left = 0, o.offset(t), l = o[0].offsetWidth, d = o[0].offsetHeight), this.replaceArrow(h - n + l, l, "left")
		...
		var i = this,
			o = this.tip(),
			n = t.Event("hide.zui." + this.type);
		if (this.$element.trigger(n), !n.isDefaultPrevented()) return o.removeClass("in"), t.support.transition && this.$tip.hasClass("fade") ? o.one(t.support.transition.end, e).emulateTransitionEnd(150) : e(), this.$element.trigger("hidden.zui." + this.type), this
	...
	e.DEFAULTS = t.extend({}, t.fn.tooltip.Constructor.DEFAULTS, {
		...
		return !!o && ("$next" == o ? e.next(".popover") : t(o))
	}, e.prototype.arrow = function() {
	...
	e.DEFAULTS = {
		...
		function e(e) {
			...
			switch (e.type) {
				case "touchstart":
					...
					break;
				case "touchend":
					var s = e.changedTouches[0].pageX - o,
						r = e.changedTouches[0].pageY - n;
		...
		var d = t.Event("slide.zui.carousel", {
			relatedTarget: n[0],
			direction: s
		});
	...
	o.DEFAULTS = {
		...
		return !!a.image && void o.modalTrigger({
			...
			custom: function(o) {
				...
				var d = s.find(".modal-dialog"),
					h = t(e).width();
				t.zui.imgReady(a.image, function() {
					d.css({
						width: i.min(h, this.width)
					}), h < this.width + 30 && s.addClass("lightbox-full"), o.ready(200)
					...
					var n = t(this),
						a = s.data("group-index") + (n.hasClass("prev") ? -1 : 1),
					...
					if (l.length) {
						...
						s.addClass("modal-loading").data("group-index", a).toggleClass("lightbox-with-caption", "string" == typeof p).removeClass("lightbox-full"), s.find(".lightbox-img").attr("src", c), s.find(".caption > .content").text(p), h = t(e).width(), t.zui.imgReady(c, function() {
							d.css({
								width: i.min(h, this.width)
							}), h < this.width + 30 && s.addClass("lightbox-full"), o.ready()
						})
					}
...
function(t, e, i) {
	...
	r.prototype.update = function(e, i) {
		...
		var l = s.placement,
			d = t(s.parent),
			h = d.children(".messagers-holder." + l);
...
function(t) {
	...
	e.DEFAULTS = {
		...
		t.find(".nav").closest("li").addClass("nav-parent"), t.find(".nav > li.active").parent().closest("li").addClass("active"), t.find(".nav-parent > a").append('<i class="' + this.options.foldicon + ' nav-parent-fold-icon"></i>'), t.find(".nav-parent.show").find(".nav-parent-fold-icon"), this.handleFold()
	}, e.prototype.handleFold = function() {
		var e = this.options.auto,
			i = this.$;
		this.$.on("click", ".nav-parent > a", function(o) {
			...
			return n.hasClass("show") ? ( n.find(".nav").slideUp(function() {
				t(this).closest(".nav-parent").removeClass("show")
			})) : ( n.find(".nav").slideDown(function() {
...
function(t, e, i, o) {
	...
	function n(t) {
		if (t = t.toLowerCase(), t && h.test(t)) {
			...
			var o = [];
			for (e = 1; e < 7; e += 2) o.push(b("0x" + t.slice(e, e + 2)));
			return {
				r: o[0],
				g: o[1],
				b: o[2],
	...
	var h = /^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$/,
		...
		C = function(t, e, i, o) {
			var a = this;
			if (a.r = a.g = a.b = 0, a.a = 1, y(o) && (a.a = l(d(o), 1)), y(t) && y(e) && y(i)) a.r = w(t), a.g = w(e), a.b = w(i);
			else if (y(t)) {
				var r = typeof t;
				if (r == u) t = t.toLowerCase(), "transparent" === t ? a.a = 0 : m[t] ? this.rgb(n(m[t])) : a.rgb(n(t));
				else if ("number" == r && v(e)) a.r = a.g = a.b = w(t);
				else if (r == g && y(t.r)) a.r = w(t.r), y(t.g) && (a.g = w(t.g)), y(t.b) && (a.b = w(t.b)), y(t.a) && (a.a = l(d(t.a), 1));
				else if (r == g && y(t.h)) {
					var h = {
						h: l(d(t.h), p),
						s: 1,
	...
	C.prototype.rgb = function(t) {
		var e = this;
		if (y(t)) {
			if (typeof t == g) y(t.r) && (e.r = w(t.r)), y(t.g) && (e.g = w(t.g)), y(t.b) && (e.b = w(t.b)), y(t.a) && (e.a = l(d(t.a), 1));
			else {
				var i = b(d(t));
				e.r = i, e.g = i, e.b = i
			}
		...
		var e = this.toHsl(),
			i = (e.h + t) % p;
		return e.h = i < 0 ? p + i : i, this.rgb(s(e))
		...
		var t = this.r / c,
			i = this.g / c,
			o = this.b / c;
		return t = t <= .03928 ? t / 12.92 : e.pow((t + .055) / 1.055, 2.4), i = i <= .03928 ? i / 12.92 : e.pow((i + .055) / 1.055, 2.4), o = o <= .03928 ? o / 12.92 : e.pow((o + .055) / 1.055, 2.4), .2126 * t + .7152 * i + .0722 * o
...
function(t) {
	...
	function e(e, i) {
		...
		return t.isArray(e) && (o = {}, t.each(e, function(e, i) {
			...
			i ? o[e] = t.extend({
				type: e
			}, s[e], t.isPlainObject(i) ? i : null) : o[e] = !1
	...
	a.DEFAULTS = {
		...
		if (r.is("li") ? (s = r.children("ul"), s.length || (s = t("<ul/>"), r.append(s), this._initList(s, r))) : s = r, s) {
			...
			t.isArray(i) || (i = [i]), t.each(i, function(e, i) {
				...
				if (i.html) n.html(i.html);
				else if (t.isFunction(d.options.itemCreator)) {
					var a = d.options.itemCreator(o, i);
					a !== !0 && a !== !1 && n.html(a)
				} else i.url ? n.append(t("<a/>", {
					href: i.url
				}).text(i.title || i.name)) : n.append(t("<span/>").text(i.title || i.name));
		...
		r && (this.selector = o + "::" + (i.name || "") + "#" + (this.$.attr("id") || n++), this.store = t.zui.store[i.name ? "get" : "pageGet"](this.selector, {})), "preserve" === s && (r ? this.isPreserve = !0 : this.options.initialState = s = "normal"), this.reload(i.data), r && (this.isPreserve = !0), "expand" === s ? this.expand() : "collapse" === s && this.collapse(), this.$.on("click", '.list-toggle,a[href="#"],.tree-toggle', function(e) {
			...
			a.callEvent("hit", {
				target: o,
				item: o.data()
			}), a.toggle(o), i.is("a") && e.preventDefault()
		...
		if (this.isPreserve)
			if (e) i = i || e.data("id"), o = void 0 === o && e.hasClass("open"), o ? this.store[i] = o : delete this.store[i], this.store.time = (new Date).getTime(), t.zui.store[this.options.name ? "set" : "pageSet"](this.selector, this.store);
			else {
				var n = this;
