  ...
  <div class="container">
    <div class="panel">
      <div class="panel-heading">
        <h2 class="title">网站关键字增加</h2>
      </div>
      <form class="form-horizontal" style="margin-top:50px;">
    <div class="form-group">
      <label for="exampleInputAccount4" class="col-sm-2">页面标题</label>
      <div class="col-md-6 col-sm-10">
        <input type="text" name="title" class="form-control" required id="exampleInputAccount4" placeholder="请输入页面的标题">
      </div>
    </div>
    <div class="form-group">
      <label for="exampleInputPassword5" class="col-sm-2">页面关键字</label>
      <div class="col-md-6 col-sm-10">
        <input type="text" name="keywords" class="form-control" required id="exampleInputPassword5" placeholder="请输入页面的关键字">
      </div>
    </div>
        <div class="form-group">
          <label for="exampleInputPassword6" class="col-sm-2">页面的描述</label>
          <div class="col-md-6 col-sm-10">
            <input type="text" name="description" class="form-control" required id="exampleInputPassword6" placeholder="请输入页面的描述">
          </div>
        </div>
    <div class="form-group">
...
<script type="text/javascript">
  $("button[name='sub']").bind('click',function(){
    ...
    $.ajax({
      type:'post',
      url:"<?php echo U('Keywords/addlist');?>",
