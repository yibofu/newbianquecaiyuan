  ...
  <div class="container">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">
        <select name="authname" class="form-control" id="exampleInputAddress7">
          ...
          <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($result['id'] == $vo['id']): ?>selected<?php endif; ?>>
    ...
    <div class="form-group">
      ...
      <div class="col-md-6 col-sm-10">
        <input type="text" name="rulename" class="form-control" id="exampleInputPassword7" value="<?php echo ($result['rule_name']); ?>">
      </div>
    </div>
    <div class="form-group">
      <label for="exampleInputPassword7" class="col-sm-2">url地址</label>
      <div class="col-md-6 col-sm-10">
        <input type="text" name="url" class="form-control" id="exampleInputPassword7" value="<?php echo ($url); ?>">
      </div>
    </div>
    <div class="form-group">
      <label for="exampleInputAddress7" class="col-sm-2">备注说明</label>
      <div class="col-md-6 col-sm-10">
        <input type="text" name="remarks" class="form-control" id="exampleInputAccount7" value="<?php echo ($result['remarks']); ?>">
      </div>
    </div>
    <div class="form-group">
      <div class="col-md-6 col-sm-10">
...
<script type="text/javascript">
  $("button[name='sub']").bind('click',function(){
    ...
    $.ajax({
      type:'post',
      url:"<?php echo U('Authrules/updatelist');?>",
