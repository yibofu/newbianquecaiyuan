  ...
  <div class="container">
    ...
    <div class="form-group">
      ...
      <div class="col-md-6 col-sm-10">
        <input type="text" name="authname" class="form-control" required id="exampleInputAccount4" value="<?php echo ($result["auth_name"]); ?>">
      </div>
    </div>
    <div class="form-group">
      <label for="exampleInputPassword4" class="col-sm-2">权限备注</label>
      <div class="col-md-6 col-sm-10">
        <input type="text" name="remarks" class="form-control" required id="exampleInputPassword4" value="<?php echo ($result["remarks"]); ?>">
      </div>
    </div>
    <div class="form-group">
      <div class="col-md-6 col-sm-10">
...
<script type="text/javascript">
  $("button[name='sub']").bind('click',function(){
    ...
    $.ajax({
      type:'post',
      url:"<?php echo U('Auths/updatelist');?>",
      ...
      success:function(data){
        ...
        if(data.error == true){
          ...
          window.location.href = "<?php echo U('Auths/index');?>";
        }else{
